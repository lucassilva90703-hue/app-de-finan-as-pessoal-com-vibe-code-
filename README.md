...
- **Chat com Miguel**  
  Registrar gastos conversando de forma natural, sem formulários complicados.

- **Classificação Automática**  
  Cada gasto é categorizado automaticamente (alimentação, transporte, lazer etc.).

- **Metas Financeiras**  
  Definição e acompanhamento de objetivos de economia.

- **Relatórios Claros e Personalizados**  
  Gráficos semanais e resumos por categoria, como visto na tela de relatórios.

- **Assistente Miguel**  
  Dá dicas rápidas de economia e mantém o tom educativo e acessível.

- **Mensagens Motivacionais**  
  - Parabenização automática ao atingir uma meta:  
    *“Parabéns! Você bateu sua meta de economia 🎉”*  
  - Convite para definir uma nova meta após bater a primeira:  
    *“Excelente! Que tal definir uma nova meta para continuar evoluindo?”*
...
O app segue princípios de **design universal**, garantindo acessibilidade e inclusão:  
